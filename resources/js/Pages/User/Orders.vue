                    ...
                    <div class="mt-6 flow-root sm:mt-8">
                        ...
                        >
                            ...
                            >
                                ...
                                <div
                                    class="w-full mt-2 grid sm:grid-cols-2 lg:flex lg:w-64 lg:items-center lg:justify-end gap-4"
                                >
                                    <button
                                        v-if="order.status === 'pending'"
                                        type="button"
                                    ...
                                    <a
                                        v-if="order.status === 'paid' || order.status === 'unpaid'"
                                        type="button"
                                        class="w-full text-center cursor-pointer rounded-lg bg-blue-700 px-3 py-2 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 lg:w-auto"
                                    >
                                        Order Again
                                    </a>
                                    <Link
                        ...
                        <ul class="flex h-8 items-center -space-x-px text-sm">
                            ...
                            <li>
                                <a
                                    href="#"
                                    aria-current="page"
                                    class="z-10 flex h-8 items-center justify-center border border-blue-300 bg-blue-50 px-3 leading-tight text-blue-600 hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white"
                                    >3</a
                                >
                            </li>
                            <li>
