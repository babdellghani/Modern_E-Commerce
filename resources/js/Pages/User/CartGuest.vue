...
const products = ref(usePage().props.productsCart);
        ...
        <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
            <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                ...
                >
                    ...
                    >
                        <div v-if="$page.props.auth.user && carts.lenght > 0" class="space-y-6">
                            <div
                                v-for="cart in carts"
                        ...
                        <div v-if="!$page.props.auth.user && products.length > 0" class="space-y-6">
                            <div
