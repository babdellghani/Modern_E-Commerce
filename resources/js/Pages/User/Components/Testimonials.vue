<template>
    <section class="bg-white dark:bg-gray-900">
        <div class="mx-auto max-w-screen-sm">
            <h2
                class="text-center mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white"
            >
                Testimonials
            </h2>
            <p
                class="text-center mb-8 font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400"
            >
            ...
            >
                ...
                >
                    ...
                    <p class="my-4">
                        ...
                        within my application. Most templates are a pain, code
            ...
            >
                ...
                >
                    ...
                    <p class="my-4">
                        ...
                        From the most used UI components like forms and
                        navigation bars to the whole app screens designed both
                        for desktop and mobile, this UI kit provides a solid
